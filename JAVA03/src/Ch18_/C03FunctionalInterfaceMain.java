...
//	+ func4.apply(Arrays.asList(11, 10.5, "TEST", true, "HELLO",new StringBuffer("HI"), 20, 40))); // 71
//	
//		System.out.println("(5) andThen 1단계     : " + func5.apply(10));                          // (10*10)+(10*10)=200
//		System.out.println("(6) andThen 2단계     : " + func6.apply(Arrays.asList(10, 20, 30)));                          // (10*10)+(10*10)=200
